...
Des Weiteren gibt es einen Knoten für alle Spieler, welche vom Typ \textit{soccer-voc:SoccerPlayer} sind. Diese sind mit dem Prädikat \textit{soccer-voc:playsFor} mit den Mannschaften verbunden. Das zuletzt genannte Prädikat und der zuletzt genannte Typ stammen von der Soccer-Voc-Ontologie. Da \textit{SoccerPlayer} eine Unterklasse von \textit{foaf:Agent} ist, kann ein \textit{SoccerPlayer} mit einem Prädikat der FOAF-Ontolgie für einen Namen versehen werden.

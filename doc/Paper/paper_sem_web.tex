...
\begin{figure}
\centering
\includegraphics[height=6.2cm]{buchsen}
...
Trainer				& - & - & - & - & +		\\ \hline
Spieltag 			& + & + & + & + & +		\\ \hline
Aktuell				& - & (last update +1 month) & + & + & +  \\ \hline
Besucherzahl			& + & - & - & - & +		\\ \hline
...
Letzte Zugriff: 26. Juni 2014\\
\url{http://www.bbc.co.uk/ontologies}

\bibitem{url_footballdata}More Football Data Projects,\\
Letzte Zugriff: 16. Juli 2014\\
\url{https://github.com/footballdata}

\bibitem{url_jquery}jQuery mobile,\\
Letzte Zugriff: 26. Mai 2014\\
\url{https://demos.jquerymobile.com/1.4.2/}

\bibitem{url_smm}Semantic Media Mining,\\
Letzte Zugriff: 22. Juli 2014\\
...
\bibitem{url_openfootball}Open Footbal,\\
Letzte Zugriff: 12. Juli 2014\\
...
\bibitem{url_openligadb}Open Liga DB,\\
Letzte Zugriff: 12. Juli 2014\\
\url{http://www.openligadb.de/Sports}
